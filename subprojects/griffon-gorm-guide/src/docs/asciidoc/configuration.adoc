...
----
dependencies {
    griffon '{project-group}:griffon-gorm-hibernate4:{project-version}'
}
----
Hibernate 5:
[source,groovy,options="nowrap"]
...
----
dependencies {
    griffon '{project-group}:griffon-gorm-hibernate5:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-gorm-hibernate5:{project-version}'
}
----
...
<dependencyManagement>
    <dependencies>
        <dependency>
            ...
            <artifactId>griffon-gorm-hibernate5</artifactId>
